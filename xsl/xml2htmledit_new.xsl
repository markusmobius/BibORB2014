 ...
 *
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:bibtex="http://bibtexml.sf.net/" exclude-result-prefixes="bibtex" version="1.0">
...
<legend>
<xsl:processing-instruction name="php">echo msg("BIBORB_OUTPUT_REQUIRED_FIELDS");</xsl:processing-instruction>
</legend>
...
<span style="color:black;font-weight:normal;font-size:small;">or/and</span>
<br/>
</xsl:if>
</xsl:for-each>
</xsl:when>
...
<br/>
<xsl:if test="not(position() = $cpt)">
<span style="color:black;font-weight:normal;font-size:small;">or</span>
<br/>
</xsl:if>
</xsl:for-each>
</xsl:when>
...
<legend>
<xsl:processing-instruction name="php">echo msg("BIBORB_OUTPUT_OPTIONAL_FIELDS");</xsl:processing-instruction>
</legend>
...
<legend>
<xsl:processing-instruction name="php">echo msg("BIBORB_OUTPUT_ADDITIONAL_FIELDS");</xsl:processing-instruction>
</legend>
...
<input name="groups" value="{$val}"/>
<br/>
<label>
<xsl:text></xsl:text>
</label>
<span style="color:black;font-weight:normal;font-size:small;">
<xsl:processing-instruction name="php">echo msg("BIBORB_OUTPUT_ADD_A_GROUP");</xsl:processing-instruction>
</span>
#XHTMLGROUPSLIST
<br/>
</xsl:when>
